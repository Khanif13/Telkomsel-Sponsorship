...
<head>
    ...
    <title>{{ config('app.name', 'Telkomsel SponsorHub') }}</title>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0 z-2">
                    ...
                    <h1 class="hero-title mb-4">
                        Empowering <br>
                        <span class="text-danger">Brilliant Ideas.</span>
                    </h1>
                    <p class="hero-subtitle mb-5 pe-lg-5">
                        Seamlessly submit, track, and manage your event sponsorship proposals with Telkomsel's fully
                        digital pipeline. Fast, transparent, and built for impact.
                    </p>
    ...
    <section class="container pb-5">
        <div
            ...
            <div class="mb-4 mb-md-0">
                <h2 class="fw-bolder mb-2">Ready to collaborate?</h2>
