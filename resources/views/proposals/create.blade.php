                                ...
                                <div class="p-4 bg-light rounded-4 border border-secondary border-opacity-25">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-6 border-end border-secondary border-opacity-25">
                                            <label class="form-label fw-semibold fs-7 text-muted">Option A: Link (Google
                                                Drive / Docs)</label>
                                            ...
                                            <div class="form-text fs-7 mt-2">Make sure the link access is set to "Anyone
                                                with the link can view".</div>
                                        </div>

                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold fs-7 text-muted">Option B: Upload PDF
                                                File</label>
