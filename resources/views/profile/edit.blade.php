        ...
        <div class="col-md-8">
            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white p-4 border-bottom-0 rounded-top-4">
                    <h5 class="fw-bold text-dark mb-0"><i class="bi bi-person-gear text-danger me-2"></i> Account Details
                    </h5>
                </div>
                <div class="card-body p-4 pt-0">
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-muted fs-7">Full Name</label>
